...
namespace Jardalu.Ratna.Web.Admin.pages.settings
{
    ...
    public partial class smtp : SettingsBasePage
    {   
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.menu.Selected = ResourceManager.GetLiteral("Admin.Settings.Smtp.Title");
            this.Title = ResourceManager.GetLiteral("Admin.Settings.Smtp.Title");
        ...
        private void PopulateNavigationAndBreadCrumb()
        {
            ...
            if (breadcrumb != null)
            {
                ...
                breadcrumb.Add(ResourceManager.GetLiteral("Admin.Settings.Smtp.Title"), Constants.Urls.Settings.SmtpUrl);
            }
        }
